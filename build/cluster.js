...
class Cluster {
    ...
    constructor(markerClusterer) {
        ...
        this._map = null;
        this._gridSize = null;
        this._minClusterSize = null;
        this._averageCenter = null;
        this._center = null;
        this._markers = [];
        this._bounds = null;
        ...
        this._markers = [];
        this._bounds = null;
        this._clusterIcon = new cluster_icon_1.ClusterIcon(this, markerClusterer.getStyles(), markerClusterer.getGridSize());
    }
    /**
